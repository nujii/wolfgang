...
stage : rel
	$(foreach dep,$(wildcard deps/* wildcard apps/*), rm -rf rel/wolfgang/lib/$(shell basename $(dep))-* && ln -sf $(abspath $(dep)) rel/wolfgang/lib;)
...
COMBO_PLT = $(HOME)/.wolfgang_combo_dialyzer_plt
